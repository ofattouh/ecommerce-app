 ...
 * @version     2.6.0
 * Changed by Omar: Changed the header text for the my account page to only show the edit your password and account details link.
 */
...
<p>
	<?php
		...
		echo sprintf( esc_attr__( 'From your account dashboard you can %1$sedit your password and account details%2$s.', 'woocommerce' ), '<a href="' . esc_url( wc_get_endpoint_url( 'edit-account' ) ) . '">', '</a>' );
