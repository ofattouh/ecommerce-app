...
class MetaSliderThemeEditor {
    ...
    public function register_theme_editor_menu() {
        ...
        $page = add_submenu_page('metaslider', __('Theme Editor', 'ml-slider-pro'), __('Theme Editor', 'ml-slider-pro'), $capability, 'metaslider-theme-editor', array($this, 'process_admin_page'));
    ...
    public function process_admin_page() {
        ...
        <div class='metaslider-ui metaslider metaslider_themeEditor'>
            ...
            <?php
                if (isset($_REQUEST['save_theme'])) {
                    echo "<div class='updated'><p>" . __("Theme Saved. To apply the theme to a slideshow, edit the slideshow and select this theme from the theme dropdown menu.", "ml-slider-pro") . "</p></div>";
                }
                ...
                if ($sliders = $this->get_sliders_for_preview()) {
                    ...
                    echo "</select>";
                    echo "<input type='submit' class='button button-secondary' value='" . __("Switch Preview Slider", "ml-slider-pro") . "' /></form>";
                }
            ?>
            ...
            <form accept-charset='UTF-8' action='?page=metaslider-theme-editor' method='post'>
                ...
                <div class='theme_editor_left'>
                    ...
                    <table class='widefat settings'>
                        <thead>
                            <tr>
                                <th width='40%'><?php _e("Theme Settings", 'ml-slider-pro') ?></th>
                                <th><input type='submit' name='save_theme' value='<?php _e("Save", "ml-slider-pro") ?>' class='alignright button button-primary' /></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td colspan='2' class='highlight'>
                                    <?php _e("Slideshow", 'ml-slider-pro') ?>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Outer Border Radius", 'ml-slider-pro') ?></td>
                                <td>
                                    <input class='number' type='number' min='0' max='50' id='theme_outer_border_radius' name='theme[outer_border_radius]' value='<?php echo $this->get_setting('outer_border_radius'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("CSS3 Shadow", 'ml-slider-pro') ?><br />
                                    <small><i><?php _e("Note: Not compatible with 'thumbnail' navigation type", 'ml-slider-pro') ?></i></small>
                                </td>
                                <td>
                                    <select id='shadow' name='theme[shadow]'>
                                        <option value='none' <?php if ($this->get_setting('shadow') == 'none') echo 'selected=selected'?>><?php _e("None", "ml-slider-pro") ?></option>
                                        <option value='effect0' <?php if ($this->get_setting('shadow') == 'effect0') echo 'selected=selected'?>><?php _e("Default", "ml-slider-pro") ?></option>
                                        <option value='effect1' <?php if ($this->get_setting('shadow') == 'effect1') echo 'selected=selected'?>><?php _e("Bottom", "ml-slider-pro") ?></option>
                                        <option value='effect2' <?php if ($this->get_setting('shadow') == 'effect2') echo 'selected=selected'?>><?php _e("Page Curl", "ml-slider-pro") ?></option>
                                        <option value='effect3' <?php if ($this->get_setting('shadow') == 'effect3') echo 'selected=selected'?>><?php _e("Bottom Curve", "ml-slider-pro") ?></option>
                                        <option value='effect4' <?php if ($this->get_setting('shadow') == 'effect4') echo 'selected=selected'?>><?php _e("Top and Bottom Curve", "ml-slider-pro") ?></option>
                                        <option value='effect5' <?php if ($this->get_setting('shadow') == 'effect5') echo 'selected=selected'?>><?php _e("Sides", "ml-slider-pro") ?></option>
                                    </select><br />
                                </td>
                            </tr>
                            <tr>
                                <td colspan='2' class='highlight'>
                                    <?php _e("Caption", 'ml-slider-pro') ?>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Enable Custom Caption", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Position", 'ml-slider-pro') ?></td>
                                <td>
                                    <select id='caption_position' name='theme[caption_position]'>
                                        <option value='bottomLeft' <?php if ($this->get_setting('caption_position') == 'bottomLeft') echo 'selected=selected'?>><?php _e("Bottom Left", 'ml-slider-pro') ?></option>
                                        <option value='bottomRight' <?php if ($this->get_setting('caption_position') == 'bottomRight') echo 'selected=selected'?>><?php _e("Bottom Right", 'ml-slider-pro') ?></option>
                                        <option value='topLeft' <?php if ($this->get_setting('caption_position') == 'topLeft') echo 'selected=selected'?>><?php _e("Top Left", 'ml-slider-pro') ?></option>
                                        <option value='topRight' <?php if ($this->get_setting('caption_position') == 'topRight') echo 'selected=selected'?>><?php _e("Top Right", 'ml-slider-pro') ?></option>
                                        <option value='underneath' <?php if ($this->get_setting('caption_position') == 'underneath') echo 'selected=selected'?>><?php _e("Underneath", 'ml-slider-pro') ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Width", 'ml-slider-pro') ?></td>
                            ...
                            <tr>
                                <td><?php _e("Border Radius", 'ml-slider-pro') ?></td>
                            ...
                            <tr>
                                <td><?php _e("Text Color", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Text Align", 'ml-slider-pro') ?></td>
                                <td>
                                    <select id='caption_align' name='theme[caption_align]'>
                                        <option value='left' <?php if ($this->get_setting('caption_align') == 'left') echo 'selected=selected'?>><?php _e("Left", 'ml-slider-pro') ?></option>
                                        <option value='center' <?php if ($this->get_setting('caption_align') == 'center') echo 'selected=selected'?>><?php _e("Center", 'ml-slider-pro') ?></option>
                                        <option value='right' <?php if ($this->get_setting('caption_align') == 'right') echo 'selected=selected'?>><?php _e("Right", 'ml-slider-pro') ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Background Color", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Vertical Margin", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='500' id='theme_caption_vertical_margin' name='theme[caption_vertical_margin]' value='<?php echo $this->get_setting('caption_vertical_margin'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Horizontal Margin", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='500' id='theme_caption_horizontal_margin' name='theme[caption_horizontal_margin]' value='<?php echo $this->get_setting('caption_horizontal_margin'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td colspan='2' class='highlight'>
                                    <?php _e("Arrows", 'ml-slider-pro') ?>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Enable Custom Arrows", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Built In Styles", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Custom Prev Arrow", 'ml-slider-pro') ?></td>
                                <td>
                                <?php
                                    ...
                                    if ($custom_prev_arrow > 0) {
                                        ...
                                        echo "<button id='open_media_manager_prev' style='display: none;'>" . __("Select", 'ml-slider-pro') . "</button>";
                                        echo "<button id='remove_custom_prev_arrow'>" . __("Remove", 'ml-slider-pro') . "</button>";
                                    ...
                                    echo "<button id='open_media_manager_prev'>" . __("Select", 'ml-slider-pro') . "</button>";
                                    echo "<button id='remove_custom_prev_arrow' style='display: none;'>" . __("Remove", 'ml-slider-pro') . "</button>";
...
?>
                            ...
                            <tr>
                                <td><?php _e("Custom Next Arrow", 'ml-slider-pro') ?></td>
                                <td>
                                <?php
                                            ...
                                            if ($custom_next_arrow > 0) {
                                                ...
                                                echo "<button id='open_media_manager_next' style='display: none;'>" . __("Select", 'ml-slider-pro') . "</button>";
                                                echo "<button id='remove_custom_next_arrow'>" . __("Remove", 'ml-slider-pro') . "</button>";
                                            ...
                                            echo "<button id='open_media_manager_next'>" . __("Select", 'ml-slider-pro') . "</button>";
                                            echo "<button id='remove_custom_next_arrow' style='display: none;'>" . __("Remove", 'ml-slider-pro') . "</button>";
...
?>
                            ...
                            <tr>
                                <td><?php _e("Opacity", 'ml-slider-pro') ?></td>
                            ...
                            <tr>
                                <td><?php _e("Distance from edge", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='-50' max='50' id='theme_arrow_indent' name='theme[arrow_indent]' value='<?php echo $this->get_setting('arrow_indent'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Always show", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td colspan='2' class='highlight'>
                                    <?php _e("Navigation", 'ml-slider-pro') ?>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Enable Custom Navigation", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id='nav_position' name='theme[nav_position]'>
                                        <option value='default' <?php if ($this->get_setting('nav_position') == 'default') echo 'selected=selected'?>><?php _e("Default", 'ml-slider-pro') ?></option>
                                        <option value='topLeft' <?php if ($this->get_setting('nav_position') == 'topLeft') echo 'selected=selected'?>><?php _e("Top Left", 'ml-slider-pro') ?></option>
                                        <option value='topCenter' <?php if ($this->get_setting('nav_position') == 'topCenter') echo 'selected=selected'?>><?php _e("Top Center", 'ml-slider-pro') ?></option>
                                        <option value='topRight' <?php if ($this->get_setting('nav_position') == 'topRight') echo 'selected=selected'?>><?php _e("Top Right", 'ml-slider-pro') ?></option>
                                        <option value='bottomLeft' <?php if ($this->get_setting('nav_position') == 'bottomLeft') echo 'selected=selected'?>><?php _e("Bottom Left", 'ml-slider-pro') ?></option>
                                        <option value='bottomCenter' <?php if ($this->get_setting('nav_position') == 'bottomCenter') echo 'selected=selected'?>><?php _e("Bottom Center", 'ml-slider-pro') ?></option>
                                        <option value='bottomRight' <?php if ($this->get_setting('nav_position') == 'bottomRight') echo 'selected=selected'?>><?php _e("Bottom Right", 'ml-slider-pro') ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td><?php _e("Vertical Margin", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='500' id='theme_nav_vertical_margin' name='theme[nav_vertical_margin]' value='<?php echo $this->get_setting('nav_vertical_margin'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Horizontal Margin", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='500' id='theme_nav_horizontal_margin' name='theme[nav_horizontal_margin]' value='<?php echo $this->get_setting('nav_horizontal_margin'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Fill Color", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Fill Color (Active)", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Border Color", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Border Color (Active)", 'ml-slider-pro') ?></td>
                                <td>
                            ...
                            <tr>
                                <td><?php _e("Size", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='50' id='theme_dot_size' name='theme[dot_size]' value='<?php echo $this->get_setting('dot_size'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Spacing", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='50' id='theme_dot_spacing' name='theme[dot_spacing]' value='<?php echo $this->get_setting('dot_spacing'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Border Width", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='50' id='theme_dot_border_width' name='theme[dot_border_width]' value='<?php echo $this->get_setting('dot_border_width'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                            <tr>
                                <td><?php _e("Border Radius", 'ml-slider-pro') ?></td>
                                <td><input class='number' type='number' min='0' max='50' id='theme_dot_border_radius' name='theme[dot_border_radius]' value='<?php echo $this->get_setting('dot_border_radius'); ?>' /><span class='after'><?php _e("px", 'ml-slider-pro') ?></span></td>
                            </tr>
                        </tbody>
                    </table>
                    <input type='submit' class='confirm button button-secondary' name='delete_theme' value='<?php _e("Delete Theme", "ml-slider-pro"); ?>' />
                </div>
