...
class MetaVimeoSlide extends MetaSlide {
    ...
    public function get_admin_tabs() {
        ...
        $general_tab = "<ul>
                            <li><label><input type='checkbox' name='attachment[{$slide_id}][settings][title]' {$title_checked}/>" . __( 'Show the title on the video', 'ml-slider-pro' ) ."</label></li>
                            <li><label><input type='checkbox' name='attachment[{$slide_id}][settings][badge]' {$badge_checked}/>" . __( 'Show the user badge on the video', 'ml-slider-pro' ) ."</label></li>
                            <li><label><input type='checkbox' name='attachment[{$slide_id}][settings][byline]' {$byline_checked}/>" . __( 'Show the user byline on the video', 'ml-slider-pro' ) ."</label></li>
                            <li><label><input type='checkbox' name='attachment[{$slide_id}][settings][portrait]' {$portrait_checked}/>" . __( 'Show the user portrait on the video', 'ml-slider-pro' ) ."</label></li>
    ...
    public function get_flex_vimeo_javascript( $javascript, $slider_id ) {
        ...
        $html .= "\n                return el.prop('data-autoPlay') == 1;";
        $html .= "\n            }";
        ...
        $html .= "\n                    $('#metaslider_{$slider_id} .flex-active-slide iframe.vimeo').prop('data-autoPlay', 0);";
        $html .= "\n                });";
    ...
    public function get_responsive_vimeo_javascript( $javascript, $slider_id ) {
        ...
        $html .= "\n                var froogaloop = Froogaloop(player_id);";
        $html .= "\n                froogaloop.addEvent('play', function(data) {";
        $html .= "\n                    $('#metaslider_{$slider_id} .rslides1_on iframe.vimeo').prop('data-autoPlay', 0);";
        $html .= "\n                });";
