...
class MetaExternalSlide extends MetaSlide {
    ...
    protected function get_admin_slide() {
        ...
        $row .= "    <div class='metaslider-ui-inner'>";
        $row .= "        <ul class='tabs'>";
        $row .= "            <li class='selected'><a tabindex='0' href='#' data-tab_id='tab-1'>" . __("General", "ml-slider-pro") . "</a></li>";
        $row .= "            <li><a tabindex='0' href='#' data-tab_id='tab-2'>" . __("SEO", "metaslider") . "</a></li>";
        $row .= "            <li><a tabindex='0' href='#' data-tab_id='tab-3'>" . __("Caption", "metaslider") . "</a></li>";
        $row .= "        </ul>";
        $row .= "        <div class='tabs-content'>";
        $row .= "            <div class='tab tab-1'>";
        $row .= "                <div class='row'><label>" . __("External Image URL", "ml-slider-pro") . "</label></div>";
        ...
        $row .= "                <div class='row'><label>" . __("Link URL", "ml-slider-pro") . "</label></div>";
        ...
        $row .= "                <div class='row'><label>" . __("Image Title Text", "ml-slider-pro") . "</label></div>";
        $row .= "                <div class='row'><input class='url' type='text' name='attachment[{$this->slide->ID}][title]' placeholder='Title Text' value='{$title}' /></div>";
        $row .= "            </div>";
        $row .= "            <div class='tab tab-2' style='display: none;'>";
        $row .= "                <div class='row'><label>" . __("Image Alt Text", "ml-slider-pro") . "</label></div>";
